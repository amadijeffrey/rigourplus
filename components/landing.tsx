...
export default function Landing(){
    ...
    return (
        ...
        <div className="px-6 sm:px-10 py-5 lg:px-40 lg:py-20  gradient">  
            <Navbar />  
            <div className='flex flex-col lg:flex-row'>
                <div  className='w-full lg:w-[50%]'>
                    <h1 className='text-2xl sm:text-5xl lg:text-8xl lg:pt-20 relative mt-14 font-semibold sm:leading-tight md:leading-tight lg:leading-tight' >Creating magic<br />in the lives of  <br /> others <span className='circles first'><i className="bi bi-thermometer-low"></i></span><span className='circles second'><i className="bi bi-heart-pulse"></i></span><span  className='circles third'>FREE SUPPORT 24/7</span></h1>
                    <h1 className=' my-10 lg:my-20 text-xl lg:text-3xl text-slate-600'>We provide a health ecosystem from Telemedicine, Ambulance request and online medicine purchase</h1>  
                  ...
                  <Image src={pictureOfDoctor} alt='picture of doctor' className='doctor-potrait '/>
                       <div className='contact'>
                            ...
                            <div>
                                ...
                                <h2 className='text-sm lg:text-3xl font-normal'>+2347045782090</h2>
                            </div>
                        </div>
                </div>
            </div>
            <div className='flex justify-between my-28 lg:my-52'>
                    <h1 className='text-xl sm:text-3xl md:text-2xl lg:text-5xl lg:leading-tight w-6/12'>Serving your health need<br />is our priority</h1>
                   <h2 className='text-sm lg:text-3xl w-5/12 text-slate-600' >We provide a health-ecosystem from Telemedicine, Ambulance request and online medicine purchase</h2>
                </div>
        </div>
        </>
    )
