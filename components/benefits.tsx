...
export default function Benefits(){
    return (
        <div className="px-10 lg:px-40 flex lg:pl-0 flex-col lg:flex-row max-h-">
            <div className=" w-full max-w-full lg:w-6/12 relative">
              <Image src={picture2} alt='doctor consulting online' className='image'/>
                <div className='appointment'>
                        ...
                        <a href='4' className='button'>Make appointment</a>
                </div>
                <div className='emergency'>
                        <h1 className='text-xl lg:text-2xl'>Emergency</h1>  
                        <a href='#' className='button '>Consultation <i className="bi bi-arrow-right ml-1"></i></a>
                        <h2 className='text-xl lg:text-2xl'>Queue</h2>
                </div>
            </div>
            <div  className=" w-full lg:w-6/12 lg:pl-10">
                <h1 className="text-3xl font-bold mt-44 sm:mt-52 lg:mt-0 lg:text-6xl mb-7">The Advantages of <br />Using Rigour+ <hr  className='bg-[#6b5dd3] h-1 w-4/12 inline-block align-middle' /></h1>
                <div className="advantages">
                    <span><i className='bi bi-journals'></i></span>
                    <div>
                        <h1 className='text-2xl lg:text-3xl'>Access to medical information</h1>
                ...
                <div className="advantages">
                    ...
                    <div>
                        <h1 className='text-2xl lg:text-3xl'>Ease of medication purchase</h1>
                ...
                <div className="advantages">
                    ...
                    <div>
                        <h1 className='text-2xl lg:text-3xl'>Premium healthcare just got more accessible</h1>
                    </div>
                </div>
            </div>
        </div>
