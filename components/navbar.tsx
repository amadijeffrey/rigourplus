        ...
        <>
            <nav className='py-5 md:flex md:items-center md:justify-between'>
                 <div className="flex justify-between items-center">
                    <Link href='/' className=' text-2xl xl:text-4xl 2xl:text-5xl font-normal'>RigourPlus</Link>
                ...
                left-0 right-0 md:w-auto transition-top-opacity ease-in-out duration-1000 ${open ? 'top-[90px] opacity-100' : '-top-[400px] opacity-0 md:opacity-100'}`}>
                    <li className=' mx-4 my-6 md:my-0'>
                        <Link href='/' className='text-base md:text-lg xl:text-2xl 2xl:text-3xl'>Home</Link>
                    </li>
                    <li className=' mx-4 my-6 md:my-0'>
                        <Link href='/blogs' className='text-base md:text-lg xl:text-2xl 2xl:text-3xl'>How It Works</Link>
                    </li>
                    <li className=' mx-4 my-6 md:my-0'>
                        <Link href='/' className='text-base md:text-lg xl:text-2xl 2xl:text-3xl'>Our Customers speak</Link>
                    </li>
